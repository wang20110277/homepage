...
export const GlareCard = ({
  ...
  return (
    <div
      ...
      className={cn("relative isolate [contain:layout_style] [perspective:600px] transition-transform duration-[var(--duration)] ease-[var(--easing)] delay-[var(--delay)] will-change-transform w-full", className)}
      ref={refElement}
      onPointerMove={(event) => {
